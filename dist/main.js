...
window.main_js = function () {
  ...
  var a = ' loading="lazy" decoding="async"';
  var i = 0;
  function n(e, t) {
    var a = "_sneeit_" + i++;
  ...
  $.fn.andSelf = function () {
    ...
    e = e.split(" ").map(function (e) {
      return (e = e.replace("fa", "gi")).replace("gice", "face");
  ...
  function w(e) {
    return "array" == typeof e || "object" == _typeof(e);
  }
  function y(e) {
  ...
  function T(e, t) {
    f(t) || (t = 300), b(e) || 0 == $(e).length || $("html, body").stop().animate({
  ...
  function P(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "gis";
    if (void 0 === e || !e || e.length < 3) return "";
    if (-1 != (e = e.trim().toLowerCase()).indexOf("<") && e.indexOf(">")) {
      var _t2 = document.createElement("div");
      _t2.innerHTML = e, e = _t2.firstChild.classNames;
    }
    var a = ["fas", "fa-classic", "fa-solid", "far", "fa-regular", "fal", "fa-light", "fat", "fa-thin", "fab", "fa-brands", "fad", "fa-classic", "fa-duotone", "fass", "fa-sharp"];
    var i = !1;
  ...
  function ne() {
    var e = (t = x(t = d.current).split("/"))[t.length - 1];
    var t;
    var _e$split = e.split("_"),
      _e$split2 = _slicedToArray(_e$split, 3),
      _e$split2$ = _e$split2[0],
      a = _e$split2$ === void 0 ? "2000" : _e$split2$,
      _e$split2$2 = _e$split2[1],
      i = _e$split2$2 === void 0 ? "01" : _e$split2$2,
      _e$split2$3 = _e$split2[2],
      n = _e$split2$3 === void 0 ? "" : _e$split2$3;
    return {
      year: a,
      month: i,
      day: n
  ...
  function fe(e) {
    ...
    "object" != _typeof(e) && (e = $(".item-thumbnail img")), e.each(function () {
      var e = $(this).parent();
  ...
  function Ae2(e) {
    ...
    if (v(t)) n = r = Math.ceil(Number(t));else if (y(t)) {
      if (-1 !== t.indexOf("x")) {
        var h = t.split("x");
  ...
  function Ae(url) {
    ...
    var forceResize = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    var width = 0,
      ...
      originalHeight = 0,
      originalSize = 0;
    var secureUrl = url.replace("http://", "https://"); // Ensure HTTPS
    var convertToWebP = !u && REPLACE_IMAGE_TO_WEBP; // Flag for WebP conversion
    ...
    if (convertToWebP && (width === height && height === 0 || size === null)) {
      ...
      var currentSize = url.split('/')[3];
      var _newUrl2 = url.replace("/".concat(currentSize, "/"), crop ? "/cover:".concat(width, "x").concat(height, "/") : "/resize:".concat(width, "x").concat(height, "/"));
    } else {
      var separator = url.includes("=") && url.includes(".googleusercontent.com") ? "=" : "/";
      var parts = secureUrl.split(separator);

      // Identify existing image size parameters
      for (var _i2 = 0; _i2 < parts.length; _i2++) {
        if (parts[_i2].length <= 17 && (parts[_i2].includes("-c") || parts[_i2].includes("s") || parts[_i2].includes("h") || parts[_i2].includes("w"))) {
          var extractedSize = parts[_i2].split("-")[0].replace("c", "").replace("s", "").replace("h", "").replace("w", "");
          if (extractedSize !== "" && !isNaN(extractedSize)) {
            if (parts[_i2].includes("s")) originalSize = Number(extractedSize);else if (parts[_i2].includes("h")) originalHeight = Number(extractedSize);else if (parts[_i2].includes("w")) originalWidth = Number(extractedSize);
            break;
          }
        }
      }
      ...
      var _newUrl3 = parts.join(separator);
    }

    // Convert image format to WebP if necessary
    if (convertToWebP) {
      var extensions = ["png", "gif", "jpeg", "jpg", "bmp"];
  ...
  function ve(e) {
    ...
    if (index0 = e.indexOf(a), -1 != index0 && (index1 = e.indexOf(i, index0), -1 == index1 && (i = "src='", n = "'", index1 = e.indexOf(i, index0)), -1 != index1 && (index2 = e.indexOf(n, index1 + i.length), -1 != index2 && (t = e.substring(index1 + i.length, index2)))), t || (a = 'data-thumbnail-src="', i = '"', index0 = e.indexOf(a), -1 != index0 && (index1 = e.indexOf(i, index0 + a.length), -1 != index0 && (t = e.substring(index0 + a.length, index1)))), !t) {
      ...
      var r = a = "youtube-nocookie.com/embed/",
        s = e.indexOf(r);
  ...
  c.postLabel = new Array(), $(".post-label-data").each(function () {
    var e = $(this).attr("data-href").replace("http:", d.protocol).replace("https:", d.protocol);
    ...
    if (t.type = t.attr("class").replace("widget ", "").replace(" ", "").toLowerCase(), e = function (e, t) {
      ...
      if (i.has("/fa") || i.has("/gi")) {
        var _e2 = i.indexOf("/fa"),
          _t4 = i.indexOf("/gi"),
          _a2 = Math.max(_e2, _t4),
          _n = i.indexOf("/", _a2 + 2);
        _n > _a2 && (i = i.substring(0, _a2) + P(i.substring(_a2 + 1, _n)) + i.substring(_n + 1));
      }
      var n = !1;
    ...
    if ("social_icons" != De.type || "linklist" != Se.type) {
      if ("social_counter" != De.type || "linklist" != Se.type) {
        ...
        for (ge = 0; ge < Se.content.length; ge++) {
          var Ee = Se.content[ge],
            $e = Ee.name,
            ke = Ee.url;
          var Ft = Ee.url.replace("http://", "").replace("https://", "").replace("www.", "").split("/")[0].split(".");
      ...
      for (var Xt = 0; Xt < Se.content.length; Xt++) {
        var qt = Se.content[Xt],
          Kt = qt.name,
  ...
  function Ne(e) {
    ...
    if (COMMENT_MEDIA_ATTACH) {
      ...
      if (null != h) for (d = 0; d < h.length; d++) {
        ...
        m.has("vimeo") && (p = H(m)) ? i.push('<iframe class="comment-media video vimeo" src="https://player.vimeo.com/video/' + p + '" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>') : R(m) ? i.push("<img".concat(a, " class=\"comment-media image\" src=\"").concat(m, "\" alt=\"comment-image\"/>")) : i.push('<a href="' + m + '" target="_blank" rel="nofollow">' + m + "</a>");
      }
    }
    for (COMMENT_EMOTICONS && $.each(o, function (t, i) {
      e = e.replaceAll(t, "<img".concat(a, " src=\"data:image/png;base64,").concat(i, "\"/>"));
    ...
    $(".post-body-inner img").each(function () {
      ...
      if (!i) {
        ...
        var t = $("h1.post-title").text(),
          i = "<img".concat(a, " src=\"").concat(e, "\" width=\"").concat(contentWidth, "\" />");
  ...
  if ($(".shortcode-col .col.col-1").each(function () {
    ...
    var e = $(this).find(".label-name").text(),
      t = $(this).attr("href").replace("?m=0", "").replace("?m=1", ""),
      a = F(e);
    var _iterator = _createForOfIteratorHelper(c.label),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var _i3 = _step.value;
        if (_i3.name == e || _i3.url == t || _i3.slug == a) return void $(this).find(".label-count-value").html(_i3.count);
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  function pt(e) {
    if ("followbyemail" == e.type && e.param.desc && e.find(".widget-content").prepend('<div class="desc">' + e.param.desc + "</div>"), "image" == e.type && f(e.param.quote)) {
      e.addClass("quote"), e.prepend("<div class=\"item-thumbnail quote-background\" style=\"opacity:0\"><img".concat(a, " src=\"").concat(e.content.src, "\"/></div>"));
      ...
      e.content.href ? i += '<a href="' + e.content.href + '">' + e.param.quote + "</a>" : i += e.param.quote, i += "</div>" + r, e.find(".widget-content").html(i), e.find(".item-thumbnail").css("height", 117 * e.outerHeight() / 100 + "px"), fe(e.find(".item-thumbnail img")), e.find(".item-thumbnail").animate({
        opacity: .3
      }, 500);
    }
    "html" != e.type || "content-section-2" != e.section_id ? e.show() : function (e) {
      if (Y() && !K()) {
        ...
        if (W()) a += "<span>" + t("LABEL") + ": </span>", ARCHIVE_PAGE_FEED_LINKS && (a += '<a target="_blank" href="' + d.feed + "/posts/default/-/" + V(c.canonicalUrl) + '">'), a += "<strong>" + function (e) {
          ...
          return !1;
        }(c.canonicalUrl) + "</strong>", ARCHIVE_PAGE_FEED_LINKS && (a += ' <i class="gis gi-rss-square"></i>');else if (_()) {
          if (d.current.has(".html")) {
            var _ne = ne(),
              _e3 = _ne.year,
              _i4 = _ne.month,
              _n2 = _ne.day;
            a += "<span>" + t("ARCHIVE") + ": </span><strong>" + _e3 + "-" + _i4 + (_n2 ? "-" + _n2 : "") + "</strong>";
          } else if (d.path.has("/")) {
          ...
          } else s = (s = d.current.split("updated-min=")[1]).split("-")[0], a += "<span>" + t("ARCHIVE") + ": </span><strong>" + s + "</strong>";
        } else G() && ("" != l.q ? a += "<span>" + t("SEARCH") + ": </span><strong>" + decodeURIComponent(l.q).replaceAll("+", " ") + "</strong>" : a += "<strong>" + t("ALL POSTS") + "</strong>");
  ...
  function ft(e) {
    return e.param.date && void 0 !== e.published ? (date = e.published, '<a class="meta-item meta-item-date" href="' + e.link + '"><i class="gi-regular gi-clock gi-lg gi-light"></i> <span>' + function (e) {
      ...
      var o = {
        ...
        yy: function yy() {
          return s.getFullYear() % 1e3;
        },
        MMMM: function MMMM() {
          return t(n[s.getMonth()]);
        },
        MMM: function MMM() {
          return t(n[s.getMonth()].substring(0, 3));
        },
        MM: function MM() {
          return (s.getMonth() >= 9 ? "" : "0") + (s.getMonth() + 1);
        },
        M: function M() {
          return s.getMonth() + 1;
        },
        ...
        dd: function dd() {
          return (s.getDate() > 9 ? "" : "0") + s.getDate();
        },
        d: function d() {
          return s.getDate();
        },
        E: function E() {
          return t(i[s.getDay()].substring(0, 3));
        },
        D: function D() {
          return s.getDate() + ([1, 21, 31].includes(s.getDate()) ? "st" : [2, 22].includes(s.getDate()) ? "nd" : [3, 23].includes(s.getDate()) ? "rd" : "th");
        },
        hh: function hh() {
          return (s.getHours() % 12).toString().padStart(2, "0");
        },
        h: function h() {
        ...
        mm: function mm() {
          return s.getMinutes().toString().padStart(2, "0");
        },
        ss: function ss() {
          return s.getSeconds().toString().padStart(2, "0");
        },
        SSS: function SSS() {
          return s.getMilliseconds().toString().padStart(3, "0");
        },
        a: function a() {
          return s.getHours() < 12 ? "AM" : "PM";
        },
        p: function p() {
          return s.getHours() < 12 ? "a.m" : "p.m";
        }
      };
      var l = [];
      for (var _e4 in o) -1 !== a.indexOf(_e4) && (a = a.replaceAll(_e4, "[$" + l.length + "$]"), l.push(o[_e4]()));
      for (var _e5 = 0; _e5 < l.length; _e5++) a = a.replaceAll("[$" + _e5 + "$]", l[_e5]);
      return a;
  ...
  function Rt(e, t) {
    ...
    if (W()) a += "/-/" + V(c.canonicalUrl);else if (_()) {
      if (d.current.has(".html")) {
        var _e6 = ne();
        o = _e6.year, h = _e6.month, m = _e6.day, r = Number(h) + (m ? 0 : 1), n = Number(o), s = m ? Number(m) + 1 : s, m || (m = 1);
        ...
        !function (e, i) {
          if (e = be(e)) {
            ...
            for (var n = "", s = 0; s < e.entry.length; s++) {
              var o = e.entry[s];
              n += '<div class="item item-' + s + '">', n += "<a href=\"".concat(o.link, "\" class=\"item-thumbnail\">\n                <img").concat(a, " src=\"").concat(Ae(o.thumbnail, 240), "\" width=\"240\"/>\n                ").concat(gt(o.format), "\n            </a>"), n += '<a href="' + o.link + '" class="item-title">' + o.title + "</a>", n += r + "</div>";
            }
